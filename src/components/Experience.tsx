    ...
    return (
        <section id="experience" ref={sectionRef} className="py-20 px-6 relative">
            <div className="container mx-auto max-w-4xl">
                ...
                <div ref={listRef} className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border/50 before:to-transparent">
                    {experiences.map((exp) => (
