    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <p ref={subtitleRef} className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
          I build intelligent AI systems focused on reasoning, evaluation, and real-world impact.
          Specializing in machine learning, predictive modeling, and data-driven solutions.
        </p>
